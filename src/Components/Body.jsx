...
const Body = () => {
    return(
        <div className="space-y-2 lg:flex lg:h-[400px]">
            <div className= "flex items-center justify-center lg:flex1 lg:order-2 lg:justify-end" >
            ...
            <div className="lg:flex-1">
                ...
                <p className="font-lato text-gray-400"> Lorem ipsum dolor sit amet consectetur adipisicing elit.  error perspiciatis doloribus sapiente quos explicabo voluptatibus pariatur quis libero, dicta esse necessitatibus rerum. </p>
